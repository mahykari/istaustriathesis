...
\setlicense{cc-by-nc-sa} % 'restricted' or any of the 'cc-by...'.
...
\Subject{Doctoral Thesis}                               % The document's subject in the document properties.
...
\usepackage{morewrites} % Increses the number of external files that can be used.
