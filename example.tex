...
\usepackage{hyperxmp}  % Enables editing of PDF metadata.
%\usepackage[type={CC},modifier={by-nc-nd},version={4.0}]{doclicense} % Sets the license metadata. See copyright licensing below.
...
\newcommand{\issn}{2663-337X} % Standard ISSN of all IST Austria theses.
...
\setlicense{restricted} % 'restricted' or any of the 'cc-by...'.
% If a Creative Commons license is chosen, the corresponding license information can be added to the PDF metadata.
% For this, the package 'doclicense' needs to be uncommented above.
...
\hypersetup{
	...
	pdfissn         = {\issn},                 % The document's ISSN in the document properties (optional).
	pdfisbn         = {\isbn},                 % The document's ISBN in the document properties (optional).
	pdfpublisher    = {IST Austria}            % The document's publisher in the document properties (optional).
}
...
% Define convenience function for an IST Austria affiliation.
\newcommand{\istaustriaaffiliation}{IST Austria, Klosterneuburg, Austria}
...
\setcosupervisor{}{Name Surname}{}{Institution, Place, Country} % Comment this line if no cosupervisor.
\setcommitteememberI{}{Name Surname}{}{\istaustriaaffiliation}
\setcommitteememberII{}{Name Surname}{}{Institution, Place, Country}
\setcommitteememberIII{}{Name Surname}{}{Institution, Place, Country} % Comment this line if no third committee member.
\setcommitteememberIIII{}{Name Surname}{}{Institution, Place, Country} % Comment this line if no fourth committee member.
\setdefensechair{}{Name Surname}{}{\istaustriaaffiliation}
...
\todo[inline]{
	...
	Consider Scientific Service Units (SSUs) at IST Austria and other staff if you got their support.}
...
\todo[inline,color=white]{
	...
	Jane Doe completed a BSc in Natural Sciences at the University of Cambridge and an MSc in Cell Biology at the University of Edinburgh before joining IST Austria in September 2016.
	...
	During her PhD studies, Jane also presented her research results at the EvoBIO conference in Parma in 2018 and helped develop the tool EVOBOT for modeling evolutionary constraints, currently hosted by IST Austria.}
\end{aboutauthor}
...
\bibentry{Turing1936} % Examplary full citation.
\end{publicationlist}
...
% This puts the lists of figures, tables, etc. and the same pages.
