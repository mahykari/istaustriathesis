...
\Copyright{Copyright \copyright\ 2026. All rights reserved.} % The document's copyright message in the document properties.
...
\setcounter{page}{1} % Reset so Abstract begins at page i.
\begin{abstract}
