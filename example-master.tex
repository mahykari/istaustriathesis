...
\setdate{2024}{02}{20} % Set signing date with 3 arguments: {day}{month}{year}.
\setissn{\issn}
...
% Some of the following persons are optional for Master's of PhD theses and can be commented if they do not apply.
